...
ENV RUST_SERVER_STARTUP_ARGUMENTS "-batchmode -load -nographics +server.secure 1 +app.publicip 72.81.224.29"
ENV RUST_SERVER_IDENTITY "docker"
ENV RUST_SERVER_PORT ""
ENV RUST_SERVER_QUERYPORT ""
ENV RUST_SERVER_SEED "1798100938"
...
ENV RUST_SERVER_WORLDSIZE "4500"
ENV RUST_SERVER_MAXPLAYERS "150 "
